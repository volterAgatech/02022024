...
$config['smtp_username'] = 'rassylkarassylkovitch@yandex.ru'; //Смените на имя своего почтового ящика. (ваш email)
...
$config['smtp_password'] = 'qmwmpkduhzrujlsf'; //Измените пароль (от вашего ящика)
